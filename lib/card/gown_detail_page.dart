            ...
            child: SingleChildScrollView(
              ...
              child: Column(
               ...
               //     '₱${widget.gownLowRentalRate.toStringAsFixed(2)} - ₱${widget.gownHighRentalRate.toStringAsFixed(2)}',
                    '₱${NumberFormat('#,##0.00').format(widget.gownLowRentalRate)} - ₱${NumberFormat('#,##0.00').format(widget.gownHighRentalRate)}',
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildDetailText(
                          'Reservation Price: ', 
                          '₱${NumberFormat('#,##0.00').format(double.parse(widget.gownReservationPrice))}', 
                          context
                        ),
                        const SizedBox(height: 10),
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return Column(
                  children: snapshot.data!.map((review) {
                    ...
                    final isHearted = review['user_reacted'] as bool? ?? false;
                      ...
                      title: Row(
                        children: [
                          ...
                          IconButton(
                            ...
                            onPressed: () {
                              _toggleHeart(review['review_id'] as int, isHearted);
                            },
                          ),
                        ],
                      ),
